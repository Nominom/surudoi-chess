...
*
* -------------------------------------------------------------------------
* Slight modifications made for use in Sharp Fox chess engine.
*
*/
...
namespace ChessEngine
{
    ...
    public static class Magic
    {
        ...
        private static readonly ulong[][] MagicBishopDb = new ulong[64][];
        ...
        private static readonly ulong[][] MagicRookDb = new ulong[64][];
        ...
        static Magic()
        {
            for (var i = 0; i < MagicBishopDb.Length; i++)
                MagicBishopDb[i] = new ulong[MagicBishopDbLength];

            for (var i = 0; i < MagicBishopDb.Length; ++i)
                MagicRookDb[i] = new ulong[MagicRookDbLength];
        ...
        public static ulong BishopAttacks(SquareIndex square, ulong occupied) => MagicBishopDb[square][((occupied & MagicmovesBMask[square]) * MagicmovesBMagics[square]) >> 55];

        public static ulong RookAttacks(SquareIndex square, ulong occupied) => MagicRookDb[square][((occupied & MagicmovesRMask[square]) * MagicmovesRMagics[square]) >> 52];

        public static ulong QueenAttacks(SquareIndex square, ulong occupied) => BishopAttacks(square, occupied) | RookAttacks(square, occupied);
